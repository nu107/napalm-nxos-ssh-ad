...
setup(
    ...
    py_modules=['nxos_ssh_ad'],
    url='https://github.com/remingu/napalm-nxos-ssh-ad',
    license='Apache 2.0',
    author='Daniel Schlifka(remingu)',
    author_email='Daniel Schlifka <remingu@techturn.de>',
    description='napalm alternative driver plugin for cisco nxos',
    install_requires=reqs,
    keywords='development napalm ios  ',
    python_requires='>=3.6',
    project_urls={
        'Bug Reports': 'https://github.com/remingu/napalm-nxos-ssh-ad/issues',
        'Source': 'https://github.com/remingu/napalm-nxos-ssh-ad',
    },
